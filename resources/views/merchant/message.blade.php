        ...
        <div class="message">
                <div class="container-fluid" id="mymsg">
                    <div class="row no-gutters">
                        ...
                        <div class="card col-md-12">
                            ...
                            <div class="msg-left">   
                                <div class="col-md-12 msg-title">
                                        <p style="margin-bottom:0" class="username text-white py-2 text-left text-dark"><img src="{{ asset('asset/back/images/message/marchant.png') }}" width="5%" class="pic-msg"></p>
                                </div>
                        ...
                        <div class="card col-md-12 pb-3">
                            <div class="msg-right">
                                <div class="col-md-12 msg-title m-b-50">
                                        <p style="margin-bottom:0" class="username  py-2 text-right"><img src="{{ asset('asset/back/images/message/admin1.png') }}" width="5%" class="pic-msg"></p>
                                </div>
                                <div class="col-md-12">                                   
                        ...
                        @endif    
                        @endforeach
                            <div class="card col-md-12 username2 pb-3" style="display:none">
                                <div class="msg-right">
                                    <div class="col-md-12 msg-title m-b-50">
                                            <p style="margin-bottom:0" class="username2  py-2 text-right"><img src="{{ asset('asset/back/images/message/admin1.png') }}" width="5%" class="pic-msg"></p>
                                    </div>
                                    <div class="col-md-12"> 
  ...
  $('#btn_msg').click(function(e) {
    ...
    jQuery.ajax({
             headers: {
               ...
               type: 'post',
               url:'{{route('merchant.message_send')}}',	
               data: {
                   message:message,
                   rcv    :rcv,
                   pro    :pro
